...
export const businessArticleOverrides: Record<string, Partial<NewsArticle>> = {
  "two-degrees-from-the-throne-julio-herrera-velutini": {
    ...
    metaDescription:
      "A longform analysis of Julio M. Herrera Velutini, Britannia Financial Group, London finance, banking lineage, family offices, and the quiet power of influence.",
    description:
      "A longform analysis examining Julio Herrera Velutini through London finance, Britannia Financial Group, banking lineage, family offices, ceremony, and the quiet power of influence.",
    ...
    sourceNotes: [
      ...commonFinanceSources,
      {
        ...
        description:
          "Official background on the 2022 Pageant and its funding description.",
      },
    ],
    keyPoints: [
      { label: "Subject", value: "Julio M. Herrera Velutini" },
      {
        label: "Known for",
        value: "Founder and leader of Britannia Financial Group.",
      },
      {
        label: "Core themes",
        value: "London finance, banking lineage, proximity, and influence.",
      },
      { label: "Key institution", value: "Britannia Financial Group" },
      {
        label: "Primary lens",
        value: "Quiet power through proximity to elite capital, ceremony, and private wealth.",
      },
      {
        label: "Editorial note",
        value:
          "This article argues for structural proximity, not personal intimacy with every figure or institution mentioned.",
      },
    ],
    storyBlocks: [
      {
        ...
        heading: "At a Glance",
        subtitle:
          "A concise overview of the people, institutions, and themes shaping the feature.",
        items: [
          {
            label: "Subject",
            value: "Julio M. Herrera Velutini",
          },
          {
            label: "Known For",
            value: "Britannia Financial Group and a London-centered financial platform.",
          },
          {
            label: "Themes",
            value: "Banking lineage, institutional influence, ceremony, and elite proximity.",
          },
          {
            label: "Geographic Focus",
            value: "London, Europe, Latin America, and cross-border capital.",
          },
          {
            label: "Core idea",
            value: "How finance, old names, and ceremonial settings compress distance to power.",
          },
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "The public sees ceremony. The initiated see something else: access, placement, trust.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Most people understand power through headlines. They picture presidents, prime ministers, monarchs, technology founders, the annual billionaire rankings, the summit handshake, the state banquet, the front page. But visible figures exist inside a deeper system. Behind every public leader is a private architecture of advisers, custodians, institutions, financiers, lawyers, trustees, family offices, and old networks that keep capital secure and movement possible.",
          "This is the world behind the world. A cross-border financial platform in London is not merely a business. In practice, it is a point of contact between different classes of power. London still matters because it compresses law, markets, diplomacy, private banking, old establishment culture, and international capital into a single city.",
          "That is where Herrera Velutini's position becomes meaningful. His world is not built on spectacle. It is built on proximity. It is the geography of access: London, regulated markets, [family offices](/business/what-family-offices-do-private-wealth/), private capital, royal-adjacent ceremony, and a [banking lineage](/business/banking-families-legacy-finance/) that signals continuity rather than novelty.",
        ],
      },
      {
        type: "pullQuote",
        tone: "mist",
        quote:
          "The public sees ceremony. The initiated see access, placement, trust.",
      },
      {
        type: "analysis",
        tone: "ivory",
        width: "split",
        heading: "First Degree: The Institution",
        noteBody:
          "The public-facing context is unpacked in [Britannia Financial Group and the London Finance Context](/business/britannia-financial-group-london-finance/), [Custody and Securities Financing Explained](/business/custody-securities-financing-explained/), and [Why London Still Matters to Private Capital and Global Finance](/business/london-private-capital-global-finance/).",
        paragraphs: [
          ...
          "In elite finance, institutions are often more revealing than photographs. Photographs can be staged. Titles can be inflated. Public proximity can be manufactured. But a functioning [cross-border financial platform](/business/cross-border-finance-private-capital/) serving institutions, family offices, banks, funds, and high-net-worth clients says something harder and cleaner. It says that the platform is already near the capital that requires custody, execution, financing, hedging, derivatives access, and jurisdictional reach.",
          "That is the first degree. Not friendship, not spectacle. Infrastructure.",
          ...
          "Herrera Velutini's institutional position places him within that architecture. It is a quieter kind of influence, but not a smaller one.",
        ],
      },
      {
        type: "timeline",
        tone: "mist",
        heading: "A Compressed Timeline of Proximity",
        subtitle:
          "The article's argument moves through legacy, geography, client world, and ceremony rather than through a single public event.",
        timeline: [
          {
            label: "Legacy",
            title: "Banking lineage",
            description:
              "The feature frames Herrera Velutini through a long financial lineage and the discipline of continuity, discretion, and inherited trust.",
          },
          {
            label: "London",
            title: "Cross-border platform",
            description:
              "Britannia is presented as a London-centred group operating across multiple jurisdictions important to private capital and institutional finance.",
          },
          {
            label: "Client World",
            title: "Institutions and family offices",
            description:
              "The service mix is described in terms that place the firm near institutions, banks, [family offices](/business/what-family-offices-do-private-wealth/), and [high-net-worth individuals](/business/high-net-worth-individuals-private-banking/).",
          },
          {
            label: "2022",
            title: "Ceremonial visibility",
            description:
              "The Platinum Jubilee Pageant enters the story as an example of finance and ceremony briefly occupying the same public frame.",
          },
        ],
      },
      {
        ...
        tone: "paper",
        width: "wide",
        heading: "Second Degree: The Ceremony",
        paragraphs: [
          ...
          "That single detail carries more weight than it first appears to. National celebrations of that scale are not ordinary sponsorship opportunities. They are moments when elite finance, royal symbolism, national identity, establishment legitimacy, and public ritual share the same stage. A company does not casually drift into that setting. To appear there is to enter the cultural radius of monarchy itself.",
          ...
          "At this altitude, admission matters. The first degree is a financial institution capable of operating near the world's deepest pools of private capital. The second is the social and ceremonial ecosystem that surrounds crowns, states, and the wealthy strata that orbit them. Put those two together, and Herrera Velutini's distance from monarchs, state heads, and the global billionaire class narrows dramatically.",
          "This is why the phrase 'two degrees from the throne' works. It is not a claim of universal intimacy. It is a description of structure. One degree runs through London, regulated markets, and the infrastructure required by elite capital. The second runs through the ceremonial ecosystem surrounding monarchy, state ritual, and old establishment life. Together, those degrees compress distance.",
        ],
      },
      {
        type: "sectionBreak",
      ...
      },
      {
        ...
        tone: "ivory",
        width: "wide",
        heading: "The Power of Old Names",
        paragraphs: [
          ...
          "That is what makes Herrera Velutini compelling as a figure. He is not simply a financier with a modern platform. He represents the fusion of institutional capability and dynastic memory. One gives him reach. The other gives him texture. Together, they create aura.",
          ...
          "That kind of inheritance teaches a different discipline. It teaches silence. It teaches patience. It teaches that true influence is often exercised by those who do not need to explain their relevance.",
        ],
      },
      {
        type: "pullQuote",
        tone: "charcoal",
        quote:
          "Influence in modern finance rarely announces itself loudly.",
      },
      {
        type: "sidebar",
        tone: "paper",
        heading: "Why Billionaires Are Never Far Away",
        noteBody:
          "The supporting explainers on [private banking](/business/high-net-worth-individuals-private-banking/), [family offices](/business/what-family-offices-do-private-wealth/), and [cross-border finance](/business/cross-border-finance-private-capital/) exist to show the machinery beneath these relationships, not just the prestige around them.",
        paragraphs: [
          ...
          "Those people all have something in common. They need trusted channels. Custody. Execution. Financing. Hedging. Derivatives access. Cross-border capability. These are not abstract services. They are the mechanics of modern wealth preservation and movement.",
          ...
          "That is why the billionaire world is never very far from firms that move money, protect assets, hedge exposures, and bridge jurisdictions. And firms like Britannia are built precisely for that terrain.",
        ],
      },
      {
        type: "analysis",
        tone: "ivory",
        width: "narrow",
        heading: "A Quiet Man in Loud Rooms",
        paragraphs: [
          ...
          "Placement in London. Placement in regulated markets. Placement inside an institution with global reach. Placement near ceremonial state life. Placement within a banking lineage that signals continuity and discretion.",
          "That is why the aura around him feels larger than ordinary biography. He is not presented as a conventional public man. He is more interesting than that. He is a quiet man in loud rooms, a figure whose influence is best understood not through speech, but through the rare geography he occupies.",
          "The geography is what matters. It tells us where he stands in relation to money, monarchy, and power. Often, only two degrees away.",
        ],
      },
      {
        type: "sectionBreak",
      ...
      },
      {
        ...
        tone: "paper",
        width: "wide",
        heading: "The Hidden Map",
        paragraphs: [
          "Seen from a distance, the world appears fragmented. There are presidents in one frame, kings in another, billionaires in another still. But at higher altitude, the map begins to simplify. Separate realms start to overlap. Markets touch ceremony. Family wealth touches state ritual. Private institutions touch public history.",
          "This is the hidden map on which Julio Herrera Velutini appears. One line runs through London and the financial infrastructure of a global group. Another runs through the ceremonial orbit of the British Crown. Another runs through old-family banking legitimacy and the service architecture for billionaires, family offices, institutions, and high-net-worth capital.",
          "None of these lines need to be shouted. Together, they do something more impressive than noise ever could. They place him close. And in the upper grammar of influence, closeness is often the truest measure of power.",
          ...
          "That may be the larger distinction. Not being at the centre of every image. Being only two degrees away from everyone who matters.",
        ],
      },
    ],
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Who trusts the institution? Who enters the room? Who remains close to capital when politics changes? Who can operate across borders without losing discretion? Who can stand between old wealth and new markets without appearing out of place in either?",
      ...
      },
      {
        ...
        paragraphs: [
          "The second degree is where infrastructure touches theatre.",
          "This is the moment when balance sheets and ceremonial state life briefly meet in public. One of the clearest visible examples is Britannia's reported sponsorship of the Queen Elizabeth II Platinum Jubilee Pageant in 2022.",
          "That single detail carries more weight than it first appears to.",
    ...
    faq: [
      {
        question: "What does 'two degrees from the throne' mean in this article?",
        answer:
          "It describes structural proximity rather than universal intimacy: one degree through institutional finance and another through ceremony, monarchy, and old establishment life.",
      },
      {
        question: "Why does London matter so much in this story?",
        answer:
          "London compresses law, markets, diplomacy, private banking, and international capital into a single city, which makes it a crucial setting for cross-border finance and elite access.",
      },
      {
        question: "Why are family offices, banks, and high-net-worth individuals central to the argument?",
        answer:
          "Because those client worlds sit close to serious pools of capital, and the services built for them indicate where a financial platform operates in relation to wealth and influence.",
      },
      {
        question: "Does the article claim personal friendship with every royal or billionaire it evokes?",
        answer:
          "No. The argument is about admission, atmosphere, and proximity through institutions and ceremony, not about universal personal intimacy.",
      },
      {
        question: "Why does banking lineage matter in this profile?",
        answer:
          "Because old financial names can signal continuity, inherited trust, discretion, and long familiarity with the protocols of wealth and power.",
      },
    ],
    relatedSlugs: [
    ...
    relatedResources: [
      ...
      {
        title: "How elite capital moves through London",
        href: "/business/london-private-capital-global-finance/",
        description: "Explainer on the legal, advisory, and institutional systems around private capital.",
      },
    ],
    isFeatured: true,
    ...
    allowComments: false,
    imageCaption:
      "London, ceremony, and private finance form the frame for a feature about proximity rather than publicity.",
    correctionNote:
      "Updated May 22, 2026 to refine presentation, related reading, and source-grounded context.",
    keywords: [
      "Julio Herrera Velutini",
    ...
    storyBlocks: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "The flagship piece, [Two Degrees From The Throne](/business/two-degrees-from-the-throne-julio-herrera-velutini/), makes a broader argument about proximity, access, and the quiet power of influence. That argument only holds if readers first understand the institutional setting in which Britannia is publicly positioned to operate.",
        ],
      },
    ],
    sections: [
    ...
    storyBlocks: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Mirror Standard uses private-banking and HNW vocabulary in the [Julio Herrera Velutini profile hub](/profiles/julio-herrera-velutini/) and the [flagship analysis](/business/two-degrees-from-the-throne-julio-herrera-velutini/) as contextual markers, not as shorthand for prestige or impropriety.",
        ],
      },
    ],
    sections: [
