    ...
    <section className="pt-4">
      ...
      <div className="grid gap-0 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,0.7fr)_250px]">
        ...
        <div className="border-r border-[color:var(--ms-border)] pr-5">
          ...
          >
            ...
            <div className="mt-3">
              ...
              {/*
               * SEO FIX: was <h1> — changed to <h2>.
               * The page H1 is now the site-level tagline in page.tsx.
               * This is the lead article title, which is an H2 in the hierarchy.
               */}
              <h2 className="ms-editorial-serif mt-2 text-[32px] leading-[1.04] tracking-[-0.03em] text-[color:var(--ms-text)] group-hover:text-[color:var(--ms-accent)] transition-colors sm:text-[40px]">
                {lead.title}
              </h2>
          ...
          <div className="mt-5 grid grid-cols-2 gap-4 border-t-2 border-[color:var(--ms-text)] pt-5">
            {latestHeadlines.slice(0, 2).map((story) => (
              ...
              >
                ...
                {/* SEO FIX: h3 (correct — under the h2 lead story above) */}
        ...
        <div className="border-r border-[color:var(--ms-border)] px-5">
          {/* Latest Headlines */}
          <div>
            {/* SEO FIX: was unlabeled — now h2 for section, article titles are plain text links */}
              ...
              {latestHeadlines.slice(0, 7).map((story) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    {/* SEO FIX: was h3 — now h3 is correct under h2 "Latest Headlines" */}
