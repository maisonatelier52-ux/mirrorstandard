...
//   // Group secondary into 2 columns of 2 items each
//   const col1 = secondary.slice(0, 2);
//   const col2 = secondary.slice(2, 4);
...
//           {/* Secondary column 1 — 2 stacked stories */}
//           <div className="flex flex-col gap-6 lg:border-r lg:border-white/10 lg:pr-6">
//             {col1.map((story, i) => (
//               <Link
//                 key={story.slug}
//                 href={`/${story.category}/${story.slug}`}
//                 className={`group flex flex-col ${i === 0 ? "border-b border-white/10 pb-6" : ""}`}
//               >
//                 <div className="relative aspect-[16/9] overflow-hidden">
//                   <Image
//                     src={story.image}
...
//           {/* Secondary column 2 — 2 stacked stories */}
//           <div className="flex flex-col gap-6">
//             {col2.map((story, i) => (
//               <Link
//                 key={story.slug}
