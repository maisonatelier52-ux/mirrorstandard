                ...
                <div ref={leftRef} className="lg:col-span-2">
                    <div>
                        <p className="text-gray-500">
                            <span className="font-semibold text-[15px] capitalize sm:text-[18px] md:text-[18px]">{article.category}</span> •{" "}
                    ...
                    <div className="flex flex-col lg:flex-row mt-2 md:gap-8 lg:gap-8">
                        ...
                        <article className="w-full max-w-4xl mx-auto px-4 md:px-0">
                            ...
                            <div className="">
                                <p className='text-[15px] leading-[1.7] text-black mb-2'>
                            ...
                            <div className="space-y-2">
                                <section>
                                    ...
                                    <p className='text-[15px] leading-[1.7] text-black mb-3'>
                                ...
                                <section>
                                    ...
                                    <ul className="space-y-2 pl-5 mb-2">
                                        <li className="flex items-start">
                                            ...
                                            <span className="text-[15px] leading-relaxed text-black">Placement in London.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="w-5 h-[1.5px] bg-black mt-[11px] mr-4 shrink-0" />
                                            <span className="text-[15px] leading-relaxed text-black">Placement in regulated markets.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="w-5 h-[1.5px] bg-black mt-[11px] mr-4 shrink-0" />
                                            <span className="text-[15px] leading-relaxed text-black">Placement inside an institution with global reach.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="w-5 h-[1.5px] bg-black mt-[11px] mr-4 shrink-0" />
                                            <span className="text-[15px] leading-relaxed text-black">Placement near ceremonial state life.</span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="w-5 h-[1.5px] bg-black mt-[11px] mr-4 shrink-0" />
                                            <span className="text-[15px] leading-relaxed text-black">Placement within a banking lineage that signals continuity and discretion.</span>
                                        </li>
                                    </ul>
                                    <p className='text-[15px] leading-[1.7] text-black mb-2'>
