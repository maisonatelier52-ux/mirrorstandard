import { formatCategoryName, getCategoryDescription } from "../lib/category-copy";
...
// Maps category to the short SEO-rich subtitle shown under H1
// These keywords mirror what's in the <title> tag so crawlers find them on-page
const categoryH1Labels: Record<string, string> = {
  business: "Business News & Market Trends",
...
export default function CategoryHeader({
  ...
  const h1Text = categoryH1Labels[category] ?? `${label} News & Latest Updates`;
    ...
    <section className="mt-4 md:mt-6">
      ...
      >
        <ol className="flex items-center gap-1.5">
          <li>
            <Link href="/" title="Mirror Standard – Home" className="hover:text-[color:var(--ms-accent)] transition-colors">
              Home
            </Link>
          </li>
      ...
      {/*
        H1: Use the full SEO-rich title (e.g. "Business News & Market Trends")
        so on-page keywords match the <title> tag.
        visually we show it at a readable size; screen readers get the full string.
      */}
      <h1 className="ms-editorial-serif text-[36px] leading-none tracking-[-0.03em] text-[color:var(--ms-text)] sm:text-[46px] font-bold">
        {h1Text}
      </h1>
      ...
      {col1 && (
        <div className="mt-6 hidden md:flex flex-row items-stretch">
          ...
          {/* Column 1 — large featured. H2 = main article heading for this page */}
          <div className="flex-2 pr-6 border-r border-[color:var(--ms-border)]">
            ...
            >
              ...
              <div className="mt-3">
                ...
                {/* H2: one instance only — desktop. Mobile uses h3 to avoid duplicate. */}
          ...
          {/* Column 3 — large right. Use h3 (not h2) to avoid a second h2 that
              duplicates when the same article also appears in the mobile stack */}
          {col3 && (
            <div className="flex-1 pl-6">
              ...
              >
                ...
                <div className="mt-3">
                  ...
                  <h3 className="ms-editorial-serif mt-2 text-[24px] leading-[1.1] tracking-[-0.03em] text-[color:var(--ms-text)] transition-colors group-hover:text-[color:var(--ms-accent)] sm:text-[26px]">
                    {col3.title}
                  </h3>
                  <p className="mt-2 line-clamp-3 text-[14px] leading-6 text-[color:var(--ms-text-soft)]">
      ...
      {/* ── Mobile fallback: stacked ──
          Lead article uses h3 here (NOT h2) because the desktop layout above
          already emits the one and only h2 for this article title.
          Both blocks are in the DOM simultaneously on desktop (hidden via CSS),
          so using h2 in both would create a duplicate h2 in the rendered HTML. -->
      */}
      {col1 && (
        <div className="mt-6 flex flex-col gap-6 md:hidden">
          ...
          >
            ...
            <div className="mt-3">
              ...
              {/* h3 intentionally — desktop block above already has the h2 for this title */}
              <h3 className="ms-editorial-serif mt-2 text-[22px] leading-[1.1] tracking-[-0.03em] text-[color:var(--ms-text)] group-hover:text-[color:var(--ms-accent)]">
                {col1.title}
              </h3>
              <p className="mt-2 line-clamp-3 text-[14px] leading-6 text-[color:var(--ms-text-soft)]">
                {col1.shortdescription}
          ...
          {secondaryArticles.map((story) => (
            <Link
              ...
              href={`/${story.category}/${story.slug}`}
              title={story.title}
              className="group flex gap-3 border-t border-[color:var(--ms-border)] pt-4"
            >
