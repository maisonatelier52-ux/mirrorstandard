import { formatCategoryName, getCategoryH1, getCategoryDescription } from "../lib/category-copy";
...
export default function CategoryHeader({
  ...
  const h1Text = getCategoryH1(category);
  ...
  return (
    <section className="mt-4 md:mt-6">
      ...
      {/* Title — now keyword-rich H1 */}
      <h1 className="ms-editorial-serif text-[36px] leading-none tracking-[-0.03em] text-[color:var(--ms-text)] sm:text-[48px] font-bold">
        {h1Text}
      </h1>
          ...
          <div className="flex-2 pr-6 border-r border-[color:var(--ms-border)]">
            ...
            >
              ...
              <div className="mt-3">
                ...
                {/* Desktop H2 — used for SEO, hidden on mobile */}
      ...
      {col1 && (
        <div className="mt-6 flex flex-col gap-6 md:hidden">
          <Link href={`/${col1.category}/${col1.slug}`} title={col1.title} className="group block">
            <div className="relative aspect-[1.6/1] w-full overflow-hidden">
              <span className="absolute left-0 top-3 z-10 bg-[#c0392b] px-2.5 py-1 text-[11px] font-bold uppercase tracking-[0.12em] text-white">
                Featured
              </span>
            ...
            <div className="mt-3">
              ...
              {/* aria-hidden to prevent duplicate H2 in DOM for SEO */}
              <p aria-hidden="true" className="ms-editorial-serif mt-2 text-[22px] leading-[1.1] tracking-[-0.03em] text-[color:var(--ms-text)] group-hover:text-[color:var(--ms-accent)] font-bold">
                {col1.title}
              </p>
            </div>
          </Link>
          {secondaryArticles.map((story) => (
            <Link key={story.slug} href={`/${story.category}/${story.slug}`} title={story.title} className="group flex gap-3 border-t border-[color:var(--ms-border)] pt-4">
              ...
              <div>
                ...
                <p className="ms-editorial-serif mt-1 text-[15px] leading-[1.2] text-[color:var(--ms-text)] group-hover:text-[color:var(--ms-accent)] font-semibold">
                  {story.title}
                </p>
              </div>
            </Link>
