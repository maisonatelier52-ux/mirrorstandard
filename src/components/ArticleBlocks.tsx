...
// /* ─────────────────────────────────────────────
//    SECTION BREAK — newspaper chapter head
// ───────────────────────────────────────────── */
// function SectionBreakBlock({ block }: { block: ArticleStoryBlock }) {
//   const inverse = block.tone === "charcoal";
//   return (
//     <section
//       className={`border px-6 py-10 text-center sm:px-10 sm:py-14 ${getToneBg(block.tone)}`}
//     >
//       <div className="mx-auto max-w-[720px]">
//         {/* decorative triple rule */}
//         <div
//           aria-hidden="true"
//           className={`mx-auto mb-6 flex w-16 flex-col gap-1 ${inverse ? "opacity-40" : ""}`}
//         >
...
//         {block.eyebrow ? (
//           <p
//             className={`font-[oswald] text-[10px] font-bold uppercase tracking-[0.32em] ${
//               inverse ? "text-white/55" : "text-[color:var(--ms-text-faint)]"
//             }`}
//           >
//             {block.eyebrow}
...
//         {block.title ? (
//           <h2
//             className={`ms-editorial-serif mt-3 text-[2rem] leading-[1.0] tracking-[-0.01em] sm:text-[2.8rem] ${
//               inverse ? "text-white" : "text-[color:var(--ms-text)]"
//             }`}
//           >
//             {block.title}
...
//         {block.subtitle ? (
//           <p
//             className={`mx-auto mt-4 max-w-[600px] text-[15px] leading-[1.8] sm:text-[16px] ${
...
//         <div
//           aria-hidden="true"
//           className={`mx-auto mt-6 flex w-16 flex-col gap-1 ${inverse ? "opacity-40" : ""}`}
//         >
//           <div className="h-[2px] w-full bg-[color:var(--ms-text)]" />
//           <div className="h-px w-full bg-[color:var(--ms-border)]" />
//           <div className="h-[2px] w-full bg-[color:var(--ms-text)]" />
