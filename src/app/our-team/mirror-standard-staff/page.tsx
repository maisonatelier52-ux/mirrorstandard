        ...
        <div className="px-8">
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              These stories often involve research, interviews, fact-checking, and careful editing from several people. Instead of listing every contributor on every story, we credit the collective: <strong className="font-bold">Mirror Standard Staff</strong> It’s our way of showing that good journalism is rarely the work of just one person.
            </p>
          </div>
