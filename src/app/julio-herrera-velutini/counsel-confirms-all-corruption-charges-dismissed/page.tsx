    ...
    return (
        <main>
                        ...
                        },
                        {
                            ...
                            "itemListElement": [
                                ...
                                },
                                {
                                    "@type": "ListItem",
                                    "position": 3,
                                    "name": "Counsel Confirms — All Corruption Charges Were Completely Dismissed",
                                    "item": "https://www.mirrorstandard.com/julio-herrera-velutini/counsel-confirms-all-corruption-charges-dismissed/"
                                }
                            ]
                        }
                    ])
            ...
            <div className="w-full max-w-7xl px-5 md:px-8 mx-auto md:mt-7 mt-4 mb-12">
                <JulioPageFive otherArticles={businessData} />
            </div>
            <ScrollToTopButton />
        </main>
    )
